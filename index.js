...
do {
opcion = await question(colores('Elige uno:\n') + opcionQR('1. Código QR\n') + opcionTexto('2. Código de 8 dígitos\n--> '))
...
do {
phoneNumber = await question(chalk.bgBlack(chalk.bold.greenBright(`Ingresa el número.\n${chalk.bold.yellowBright(`Ejemplo: 1829*******`)}\n${chalk.bold.magentaBright('---> ')}`)))
